...
class Model(object):
    def __init__(self,
        ...
        logging.info('encoder length : %d', self.encoder_size)
        logging.info('decoder length : %d', self.decoder_size)
        ...
        for batch in s_gen.gen(1):
            ...
            if self.visualize:
                ...
                visualize_attention(batch['data'],
                                    ...
                                    binarize=binarize,
                                    ground=ground,
                                    flag=None,out_folder_name=folder_counter)
                folder_counter += 1
